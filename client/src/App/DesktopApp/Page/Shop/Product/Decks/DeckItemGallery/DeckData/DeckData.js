...
const DeckData = ( props ) => {
    ...
    const [ deckThree ] = useState( () => {
        return `<p>
                <span>
                לפעמים חלליות מעופפות אל הדמיון, במציאות שכל אחד יודע להמציא.
    ...
    const [ deckFour ] = useState( () => {
        return `<p>
                <span>
                אני שולח לך מסר בבקבוק, שגם אם אתה קפטן הוק.
                הסקייטרים כפיטר-פן, כולם יודעים לעוף. וזה בגלל שהם יודעים את התשובה.
                וזה גם יום אחד יכול להיות אתה.
                </span>
                <p>&nbsp;</p>
                <p>עיצוב: 'שוגר'</p>
                </p>`
