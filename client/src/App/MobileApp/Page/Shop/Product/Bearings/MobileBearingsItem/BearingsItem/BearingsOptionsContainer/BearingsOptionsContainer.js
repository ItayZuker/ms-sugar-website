...
import DropdownBearingsOption from './DropdownBearingsOption/DropdownBearingsOption'
import './bearings_options_container.scss'

const BearingsOptionsContainer = ( props ) => {
    ...
    return (
        <div className='bearings_options_container'>
            <div 
...
export default BearingsOptionsContainer