...
const GripData = ( props ) => {
    ...
    const translateTitle = ( title ) => {
        switch ( title ) {
            ...
            case 'grip #3': return 'גריפ #3'
            case 'grip #4': return 'גריפ #4'
            case 'grip #5': return 'גריפ #5'
    ...
    return (
        <div className={ 'mobile_grip_data_container ' + ( appState.language === 'english' ? '' : 'hebrew' ) }>
