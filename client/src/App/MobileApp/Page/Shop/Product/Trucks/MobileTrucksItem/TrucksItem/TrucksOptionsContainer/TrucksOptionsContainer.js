...
import DropdownTrucksOption from './DropdownTrucksOption/DropdownTrucksOption'
import './trucks_options_container.scss'

const TrucksOptionsContainer = ( props ) => {
    ...
    return (
        <div className='trucks_options_container'>
            <div 
...
export default TrucksOptionsContainer