...
import DropdownWheelOption from './DropdownWheelOption/DropdownWheelOption'
import './wheels_options_container.scss'

const WheelsOptionsContainer = ( props ) => {
    ...
    return (
        <div className='wheels_options_container'>
            <div 
...
export default WheelsOptionsContainer